function About() {
	return (
		<div className=" h-screen left-0 bg-background bg-cover">
			...
			<a href="https://moon.nasa.gov/resources/13/apollo-11-seismic-experiment/#:~:text=The%20Passive%20Seismic%20Experiment%20was,Aldrin%20with%20the%20seismic%20experiment." target={"_blank"}>
			...
			<a href="https://www.usgs.gov/publications/results-apollo-12-passive-seismic-experiment" target={"_blank"}>
				<div className="text-white ">
			...
			<a href="https://www.space.com/apollo-13-moon-rocket-impact-experiment-restored-video.html" target={"_blank"}>
				<div className="text-white ">
			...
			<a href="https://www.lpi.usra.edu/lunar/missions/apollo/apollo_14/experiments/pse/" target={"_blank"}>
				<div className="text-white ">
					<p className="text-[18px] absolute left-[1000px] top-[450px] text-center">Apollo 15 Seismic  <br /> Experiment <br /> 1986</p>
				</div>
			</a>

			<a href="https://www.lpi.usra.edu/lunar/missions/apollo/apollo_16/experiments/ps/#:~:text=The%20Passive%20Seismic%20Experiment%20detected,at%20the%20Moon's%20internal%20structure." target={"_blank"}>
				<div className="text-white ">
